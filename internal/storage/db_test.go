...
func TestOpenAndMigrate(t *testing.T) {
	...
	// Verify tables exist
	tables := []string{"entries", "vec_entries", "entities", "relations", "learnings", "chunks_meta", "chunks_fts", "vec_chunks", "compile_items", "method_units", "answer_cards", "concept_units", "article_units"}
